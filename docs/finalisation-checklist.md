...
| Disponibilité avant publication | aucune panne ni dérive sur sept jours ; aucun réveil dépassant 30 s | journal `surveillance`, résumé sur sept jours avec `--exiger-sans-defaut` | ⚠️ 4 réveils de 32,4–32,7 s sur 5 mesures |
...
- accès ou arbitrage Render (instance sans veille ou mécanisme de maintien
  réellement fiable) ;
